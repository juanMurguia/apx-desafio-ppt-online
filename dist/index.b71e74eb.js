...
var _index1 = require("./components/hands/index");
...
(function() {
    ...
    // @ts-ignore
    const imgUrl = require("237114b37ba4ffe3");
    style.innerHTML = `
  body{ 
    center fixed;
  ...
  `;
    ...
    `;
        ...
        if (customButton) customButton.addEventListener("click", ()=>{
            localStorage.removeItem("localState");
            window.location.reload();
        });
    } else console.error("Elemento con la clase '.root' no encontrado.");
})();

},{"./components/button/index":"dZaQH","./components/hands/index":"gu1fe","./router":"4QFWt","./state":"1Yeju","237114b37ba4ffe3":"lInfF"}],"dZaQH":[function(require,module,exports) {
class Button extends HTMLElement {
    ...
    render() {
        ...
        button.textContent = " ";
        if (location.pathname == "/home" && this.className == "join-game") return button.textContent = "Unirse";
        if (location.pathname == "/home" && this.className == "new-game-home") return button.textContent = "Nuevo juego";
        if (location.pathname == "/new-game" && this.className == "new-game") return button.textContent = "Empezar";
        if (location.pathname == "/join-game" && this.className == "join-game") return button.textContent = "Unirse";
        if (location.pathname == "/instructions" && this.className == "instructions") return button.textContent = "Jugar";
        if (location.pathname == "/result" && this.className == "result") return button.textContent = "Jugar otra vez";
    }
}
customElements.define("custom-button", Button);

},{}],"gu1fe":[function(require,module,exports) {
class Hands extends HTMLElement {
    ...
    render() {
        //@ts-ignore
        const piedraImg = require("4d9ba9226d089bcd");
        //@ts-ignore
        const papelImg = require("683beeb37f8c1b4c");
        //@ts-ignore
        const tijerasImg = require("2acc0087bc45b1e3");
        ...
        papper.addEventListener("click", (e)=>{
            let id;
            if (e.path[1].id == "") id = e.path[0].id;
            else id = e.path[1].id;
            const event = new CustomEvent("clicked", {
...
},{"4d9ba9226d089bcd":"2Elxg","683beeb37f8c1b4c":"lo2s2","2acc0087bc45b1e3":"1Q7O8"}],"2Elxg":[function(require,module,exports) {
module.exports = require("a99737854dc17e31").getBundleURL("7UhFu") + "piedrar.f3504767.png" + "?" + Date.now();

},{"a99737854dc17e31":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"lo2s2":[function(require,module,exports) {
module.exports = require("3f73a44fc379c537").getBundleURL("7UhFu") + "papelr.eebef3f8.png" + "?" + Date.now();

},{"3f73a44fc379c537":"lgJ39"}],"1Q7O8":[function(require,module,exports) {
module.exports = require("6c4e29c4da304f97").getBundleURL("7UhFu") + "tijerasr.df130336.png" + "?" + Date.now();

},{"6c4e29c4da304f97":"lgJ39"}],"4QFWt":[function(require,module,exports) {
...
var _index2 = require("./pages/game/index");
var _index3 = require("./pages/show-moves/index");
var _index4 = require("./pages/result/index");
var _index5 = require("./pages/new-game/index");
var _index6 = require("./pages/join-game/index");
var _index7 = require("./pages/waiting-for-opponent/index");
var _index8 = require("./pages/waiting-ready-opponent/index");
var _state = require("./state");
...
function routeHandler(path, container) {
    const routes = [
        {
            path: /\/home/,
            handler: (container)=>{
                (0, _index.initHomePage)(container);
            }
        },
        {
            path: /\/new-game/,
            handler: (container)=>{
                (0, _index5.initNewGamePage)(container);
            }
        },
        {
            path: /\/join-game/,
            handler: (container)=>{
                (0, _index6.initJoinGamePage)(container);
            }
        },
        {
            path: /\/waiting-for-opponent/,
            handler: (container)=>{
                (0, _index7.initWFOPage)(container);
            }
        },
        {
            path: /\/instructions/,
            handler: (container)=>{
                (0, _index1.initInstructionsPage)(container);
            }
        },
        {
            path: /\/wfro/,
            handler: (container)=>{
                (0, _index8.initWFOReadyPage)(container);
            }
        },
        {
            path: /\/game/,
            handler: (container)=>{
                (0, _index2.initGamePage)(container);
            }
        },
        {
            path: /\/show-moves/,
            handler: (container)=>{
                (0, _index3.initShowMovesPage)(container);
            }
        },
        {
            path: /\/result/,
            handler: (container)=>{
                (0, _index4.initResultPage)(container);
            }
        }
    ];
    ...
    for (const r of routes)if (r.path.test(path)) r.handler(container);
}
...
async function initRouter() {
    const { gameState } = await (0, _state.state).getState();
    if (gameState.currentPage == null) goTo("/home");
    else goTo(gameState.currentPage);
}

},{"./pages/home/index":"l5Ogl","./pages/instructions/index":"c8fMJ","./pages/game/index":"c5SNR","./pages/show-moves/index":"C4MVA","./pages/result/index":"7wfLH","./pages/new-game/index":"7L3D2","./pages/join-game/index":"exqsM","./pages/waiting-for-opponent/index":"3imVn","./pages/waiting-ready-opponent/index":"jQBmD","./state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l5Ogl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initHomePage(containerEl) {
  ...
  `;
    ...
    newGameBttn.addEventListener("click", ()=>{
        (0, _router.goTo)("/new-game");
    });
    joinGameBttn.addEventListener("click", ()=>{
        (0, _router.goTo)("/join-game");
    });
    containerEl.appendChild(style);
}

},{"../../router":"4QFWt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
var _router = require("../../router");
var _state = require("../../state");
function initInstructionsPage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
 ...
 <br>
    ...
    bttn?.addEventListener("click", async ()=>{
        await (0, _state.state).setPlayerReadyStatus(true);
        (0, _router.goTo)("/wfro");
    });
    containerEl.appendChild(style);
}
...
const state = {
    ...
    init () {
        ...
        if (localState != null) {
            ...
            (0, _router.goTo)(this.data.gameState.currentPage);
    ...
    async saveScoreboard () {
        ...
        const rawHistoryData = await fetch(`${(0, _db.API_BASE_URL)}/history/${data.gameState.publicId}`);
    },
    getState () {
        return this.data;
    },
    ...
    async signIn () {
        ...
        const rawUser = await fetch(`${(0, _db.API_BASE_URL)}/auth`, {
            method: "post",
            headers: {
    ...
    async askNewRoom () {
        const { gameState } = await this.getState();
        const rawPublicRoomId = await fetch(`${(0, _db.API_BASE_URL)}/rooms`, {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    async getExistingRoomId (roomId) {
        const { gameState } = await this.getState();
        await this.setPublicId(roomId);
        const rawPrivateRoomId = await fetch(`${(0, _db.API_BASE_URL)}/room/${roomId}`, {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    async joinRoom () {
        ...
        data.gameReady = true;
        fetch(`${(0, _db.API_BASE_URL)}/room/${data.gameState.publicId}/join`, {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    async checkForOpponent () {
        const { gameState } = await this.getState();
        const db = (0, _db.getDatabase)((0, _db.app));
        const roomRef = (0, _db.ref)(db, `rooms/${await gameState.privateId}`);
        (0, _db.onValue)(roomRef, (snapshot)=>{
            const data = snapshot.val();
            if (Object.keys(data).length === 2) {
                this.setGameReadyStatus(true);
                if (gameState.name === data.owner.name) gameState.opponentName = data.guest.name;
                if (gameState.name === data.guest.name) gameState.opponentName = data.owner.name;
            }
        });
    },
    async setGameReadyStatus (online) {
        ...
        if (online === true) {
            ...
            if (location.pathname === "/waiting-for-opponent") (0, _router.goTo)("/instructions");
        }
    ...
    async setPlayerReadyStatus (status) {
        ...
        fetch(`${(0, _db.API_BASE_URL)}/room/${gameState.publicId}/play`, {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
    ...
    async checkIfBothAreReady () {
        ...
        (0, _db.onValue)(roomRef, (snapshot)=>{
            const data = snapshot.val();
            //temporal
            if (data.owner.ready == false && data.guest.ready == false) return;
            if (data.owner.ready == false && data.guest.ready == true) return this.waitingForOpponent(data.owner.name, false);
            if (data.owner.ready == true && data.guest.ready == false) return this.waitingForOpponent(data.guest.name, false);
            if (data.owner.ready == true && data.guest.ready == true) return this.waitingForOpponent("ready", true);
            if (Object.keys(data).length === 2) {
                if (gameState.name === data.owner.name) gameState.opponentName = data.guest.name;
                if (gameState.name === data.guest.name) gameState.opponentName = data.owner.name;
            }
    ...
    async waitingForOpponent (name, bothReady) {
        ...
        if (bothReady === true) {
            ...
            if (location.pathname === "/wfro") (0, _router.goTo)("/game");
        } else if (bothReady === false) startGame.gameState.opponentName = name;
    },
    ...
    async getMovesFromRtdb () {
        ...
        (0, _db.onValue)(roomRef, (snapshot)=>{
            const data = snapshot.val();
            if (data.owner.play != null && data.guest.play != null) return this.setMoves(data.owner.play, data.guest.play);
        });
    },
    // setea los moves del OWNER y GUEST en los respectivos states de los clientes
    async setMoves (ownerPlay, guestPlay) {
        const { gameState } = await this.getState();
        if (gameState.owner) return gameState.opponentPlay = guestPlay;
        if (gameState.owner == false) return gameState.opponentPlay = ownerPlay;
    },
    ...
    whoWins (ownerPlay, guestPlay) {
        ...
        for (const o of ownerWinningOutcomes){
            if (o.ownerPlay == ownerPlay && o.guestPlay == guestPlay) ownerResult = "ganaste";
            else if (ownerPlay == guestPlay) ownerResult = "empate";
        }
        let guestResult = "";
        if (ownerResult == "perdiste") guestResult = "ganaste";
        else if (ownerResult == "ganaste") guestResult = "perdiste";
        else if (ownerResult == "empate") guestResult = "empate";
    ...
    saveHistory (history) {
        ...
        localStorage.setItem("localState", JSON.stringify(data));
        fetch(`${(0, _db.API_BASE_URL)}/history/save/${data.gameState.publicId}`, {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
...
},{"./db":"98qAp","./router":"4QFWt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"98qAp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_BASE_URL", ()=>API_BASE_URL);
parcelHelpers.export(exports, "getDatabase", ()=>(0, _database.getDatabase));
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c5SNR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initGamePage", ()=>initGamePage);
var _router = require("../../router");
var _state = require("../../state");
async function initGamePage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
    ...
    custombttn.addEventListener("clicked", async (e)=>{
        const playerPlay = e.detail.play;
        await (0, _state.state).setGame(playerPlay);
        await (0, _state.state).getMovesFromRtdb();
    });
    ...
    setTimeout(async ()=>{
        ...
        if (gameState.play == null) {
            ...
            await (0, _state.state).setGame(randomplay);
            await (0, _state.state).getMovesFromRtdb();
        }
    }, 4000);
    setTimeout(()=>{
        if (location.pathname != "/game") return;
        if (location.pathname == "/game") (0, _router.goTo)("/show-moves");
    }, 5000);
    // esto hace la animacion del 3, 2, 1
    const counters = document.querySelectorAll(".counter-off");
    function counter(counterEls) {
        for (const el of counterEls){
            setTimeout(()=>{
                if (el.innerText == "3") el.setAttribute("class", "counter");
            }, 1000);
            setTimeout(()=>{
                if (el.innerText == "3") el.setAttribute("class", "counter-off");
                if (el.innerText == "2") el.setAttribute("class", "counter");
            }, 2000);
            setTimeout(()=>{
                if (el.innerText == "2") el.setAttribute("class", "counter-off");
                if (el.innerText == "1") el.setAttribute("class", "counter");
            }, 3000);
            setTimeout(()=>{
                if (el.innerText == "1") el.setAttribute("class", "counter-off");
            }, 4000);
        }
    }
    counter(counters);
...
},{"../../router":"4QFWt","../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"C4MVA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initShowMovesPage", ()=>initShowMovesPage);
var _router = require("../../router");
var _state = require("../../state");
function initShowMovesPage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
  ...
  `;
    //@ts-ignore
    const piedraImg = require("b0a9d9251765968d");
    //@ts-ignore
    const papelImg = require("ab9955f0f46ea76c");
    //@ts-ignore
    const tijerasImg = require("e951302deba4b811");
    //obtengo la jugada
    const { gameState } = (0, _state.state).getState();
    //selecciono la jugada y la muestro
    const ownerImgSelector = (guestPlay)=>{
        if (guestPlay == "piedra") return piedraImg;
        if (guestPlay == "papel") return papelImg;
        if (guestPlay == "tijera") return tijerasImg;
    };
    const guestImgSelector = (ownerPlay)=>{
    ...
    if (gameState.owner == true) {
        (0, _state.state).whoWins(gameState.play, gameState.opponentPlay);
        div.innerHTML = `
    <div class="machine-container">
    <img width="200px" height="250px" src=${guestImgSelector(gameState.opponentPlay)}>
    </div>
    ...
    if (gameState.owner == false) {
        (0, _state.state).whoWins(gameState.opponentPlay, gameState.play);
        div.innerHTML = `
    <div class="machine-container">
    <img width="200px" height="250px" src=${ownerImgSelector(gameState.opponentPlay)}>
    </div>
    <div class="player-container">
...
},{"../../router":"4QFWt","../../state":"1Yeju","b0a9d9251765968d":"2Elxg","ab9955f0f46ea76c":"lo2s2","e951302deba4b811":"1Q7O8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7wfLH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initResultPage", ()=>initResultPage);
var _router = require("../../router");
var _state = require("../../state");
async function initResultPage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
  ...
  `;
    await (0, _state.state).setPlayerReadyStatus(false);
    const data = (0, _state.state).getState();
    ...
    if (data.gameState.owner === true) {
      ...
      `;
        function showResult(result) {
            if (result == "ganaste") return resultContainer.setAttribute("class", "ganaste");
            if (result == "perdiste") return resultContainer.setAttribute("class", "perdiste");
            if (result == "empate") return resultContainer.setAttribute("class", "empate");
        }
...
},{"../../router":"4QFWt","../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7L3D2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initNewGamePage", ()=>initNewGamePage);
var _router = require("../../router");
var _state = require("../../state");
function initNewGamePage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
...
.form{
  ...
  `;
    ...
    form.addEventListener("submit", async function action(e) {
        ...
        if (data.value == "") return window.alert("Please enter your name");
        form.removeChild(form.querySelector(".bttn"));
        containerEl.appendChild(document.createElement("custom-button"));
        (0, _state.state).setName(data.value.toString());
        await (0, _state.state).signIn();
        await (0, _state.state).askNewRoom();
        containerEl.querySelector("custom-button").remove();
        (0, _router.goTo)("/waiting-for-opponent");
    });
    containerEl.appendChild(style);
}

},{"../../router":"4QFWt","../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"exqsM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initJoinGamePage", ()=>initJoinGamePage);
var _router = require("../../router");
var _state = require("../../state");
function initJoinGamePage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
...
`;
  ...
  `;
    ...
    form?.addEventListener("submit", async (e)=>{
        ...
        const roomId = document.querySelector(".name-input");
        if (name.value == "") return window.alert("Please enter your name");
        if (roomId.value == "") return window.alert("Please enter the room ID");
        form.removeChild(document.querySelector(".bttn"));
        containerEl.appendChild(document.createElement("custom-button"));
        (0, _state.state).setName(name.value.toString());
        await (0, _state.state).signIn();
        await (0, _state.state).getExistingRoomId(roomId.value.toString());
        await (0, _state.state).joinRoom();
        containerEl.querySelector("custom-button").remove();
...
},{"../../router":"4QFWt","../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3imVn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWFOPage", ()=>initWFOPage);
var _state = require("../../state");
async function initWFOPage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
  ...
  `;
    await (0, _state.state).checkForOpponent();
    containerEl.appendChild(div);
    containerEl.appendChild(style);
    const contenedor = containerEl.querySelectorAll(".container");
    const estilos = containerEl.querySelectorAll(".style");
...
},{"../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jQBmD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWFOReadyPage", ()=>initWFOReadyPage);
var _state = require("../../state");
async function initWFOReadyPage(containerEl) {
    const div = document.createElement("div");
    div.setAttribute("class", "container");
    const style = document.createElement("style");
    style.setAttribute("class", "style");
  ...
  `;
    await (0, _state.state).checkIfBothAreReady();
    containerEl.appendChild(div);
    containerEl.appendChild(style);
}

},{"../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lInfF":[function(require,module,exports) {
module.exports = require("a762a51ea52dbd23").getBundleURL("7UhFu") + "thisone.65c0f02f.png" + "?" + Date.now();

},{"a762a51ea52dbd23":"lgJ39"}]},["fm8Gy","h7u1C"], "h7u1C", "parcelRequire9acc")
